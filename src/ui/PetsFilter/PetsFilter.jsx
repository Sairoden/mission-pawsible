      ...
      <form className="filter-form">
        ...
        <div className="body">
          ...
          <div className="species">
            ...
            <div className="choices">
              <input type="checkbox" id="dog" className="checkbox" />
          ...
          <div className="size">
            ...
            <div className="choices">
              <input type="checkbox" id="small" className="checkbox" />
            ...
            <div className="choice">
              <input type="checkbox" id="medium" className="checkbox" />
            ...
            <div className="choice">
              <input type="checkbox" id="large" className="checkbox" />
          ...
          <div className="location">
            ...
            <div className="choices">
              <input type="checkbox" id="manila" className="checkbox" />
            ...
            <div className="choices">
              <input type="checkbox" id="quezon" className="checkbox" />
